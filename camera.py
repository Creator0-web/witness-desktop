"""Webcam presence detection. Tries camera slots 0-2. Pushes a 'greet'
event when you sit down (first arrival of day, or return after 3+ min away).
No frames are ever saved — detection only."""
import threading
import time
