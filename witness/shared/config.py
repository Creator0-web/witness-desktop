...
# ── Files ────────────────────────────────────────────────────────────────
# Intentionally relative. profile_runtime.py changes the process working
# directory to this Windows user's isolated WITNESS data folder before
# config/db/core modules load, so legacy code stays compatible without
# storing personal data beside the application code.
DB_PATH = "witness.db"
